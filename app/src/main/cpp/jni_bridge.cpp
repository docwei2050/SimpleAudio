...
Java_com_docwei_simpleaudio_PlaybackEngine_native_1deleteEngine(
        JNIEnv *env,
        jclass,
        jlong engineHandle) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setToneOn(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
        jboolean isToneOn) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setAudioApi(
        JNIEnv *env,
        jclass type,
        jlong engineHandle,
        jint audioApi) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setAudioDeviceId(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
        jint deviceId) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setChannelCount(
        JNIEnv *env,
        jclass type,
        jlong engineHandle,
        jint channelCount) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setBufferSizeInBursts(
        JNIEnv *env,
        jclass,
        jlong engineHandle,
...
Java_com_docwei_simpleaudio_PlaybackEngine_native_1getCurrentOutputLatencyMillis(
        JNIEnv *env,
        jclass,
        jlong engineHandle) {
...
Java_com_docwei_simpleaudio_PlaybackEngine_native_1isLatencyDetectionSupported(
        JNIEnv *env,
        jclass type,
        jlong engineHandle) {
...
JNIEXPORT void JNICALL
Java_com_docwei_simpleaudio_PlaybackEngine_native_1setDefaultStreamValues(
        JNIEnv *env,
        jclass type,
        jint sampleRate,
        jint framesPerBurst) {
